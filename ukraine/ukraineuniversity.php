...
<head>
  ...
  <title>Ukraine-Universities</title>
...
<body class="container-fluid">
  ...
  <main class="container">
    ...
    <!---Universities-->
    <h1 class="text-center">UKRAINE</h1><br>
    <div class="" style="width: 28rem;">
      <div class="card-header text-center">
        UNIVERSITIES
      </div>
      <ul class="list-group list-group-flush">
        <li class="list-group-item"><a href="onmu.php">&#9851; Odessa National Medical University </a></li>

        <li class="list-group-item"><a href="tsmu.php">&#9851; Ternopil State Medical University</a></li>
