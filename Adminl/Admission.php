        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="Enquiry.php"> <i class="menu-icon fa fa-users"></i>Enquiry Details </a></li>
                    <li class="active"><a href="Admission.php"> <i class="menu-icon fa fa-address-book"></i>Admission Details </a></li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"><a href="#">Admission Details</a></li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container">
    <h2 class="text-center">Not Yet Registered</h2>
